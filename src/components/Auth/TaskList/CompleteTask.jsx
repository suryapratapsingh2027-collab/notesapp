...
const CompleteTask = ({ data }) => {
    return (
        <div className='h-full shrink-0 w-[30%] bg-yellow-400 rounded-2xl flex flex-col justify-between p-5'>
            ...
            <div className='mt-5 flex justify-center'>
                <button className='bg-blue-500 text-white cursor-pointer px-4 py-2 rounded font-semibold'>Complete</button>
            </div>
        </div>
    )
}
